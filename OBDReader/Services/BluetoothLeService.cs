...
public class BluetoothLeService
{
    ...
    public async Task<List<DeviceCandidate>> ScanForDevicesAsync()
    {
        ...
        try
        {
            IReadOnlyList<IDevice> systemDevices = Adapter.GetSystemConnectedOrPairedDevices(ObdUuids.ObdServiceUuids);
            ...
            await Adapter.StartScanningForDevicesAsync(ObdUuids.ObdServiceUuids);
        }
        catch (Exception ex)
        {
